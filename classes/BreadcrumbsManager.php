...
use ThatoBabusi\Breadcrumbs\Exceptions\DuplicateBreadcrumbException;
use ThatoBabusi\Breadcrumbs\Exceptions\InvalidBreadcrumbException;
use ThatoBabusi\Breadcrumbs\Exceptions\UnnamedRouteException;
use ThatoBabusi\Breadcrumbs\Exceptions\ViewNotSetException;
...
class BreadcrumbsManager
{
     ...
     * @return void
     * @throws \ThatoBabusi\Breadcrumbs\Exceptions\DuplicateBreadcrumbException If the given name has already been
     *     used.
     */
     ...
     * @throws \ThatoBabusi\Breadcrumbs\Exceptions\UnnamedRouteException if no name is given and the current route
     *     doesn't have an associated name.
     * @throws \ThatoBabusi\Breadcrumbs\Exceptions\InvalidBreadcrumbException if the name is (or any ancestor names
     *     are) not registered.
     */
     ...
     * @throws \ThatoBabusi\Breadcrumbs\Exceptions\InvalidBreadcrumbException if the name is (or any ancestor names are) not registered.
     * @throws \ThatoBabusi\Breadcrumbs\Exceptions\UnnamedRouteException if no name is given and the current route doesn't have an associated name.
     * @throws \ThatoBabusi\Breadcrumbs\Exceptions\ViewNotSetException if no view has been set.
     */
     ...
     * @throws \ThatoBabusi\Breadcrumbs\Exceptions\UnnamedRouteException if the current route doesn't have an associated name.
     * @throws \ThatoBabusi\Breadcrumbs\Exceptions\InvalidBreadcrumbException if the name is (or any ancestor names are) not registered.
     */
