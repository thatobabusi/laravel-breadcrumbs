...
class ExceptionsTest extends TestCase
{
    ...
    {
        $this->expectException(\ThatoBabusi\Breadcrumbs\Exceptions\DuplicateBreadcrumbException::class);
    ...
    {
        $this->expectException(\ThatoBabusi\Breadcrumbs\Exceptions\InvalidBreadcrumbException::class);
    ...
    {
        $this->expectException(\ThatoBabusi\Breadcrumbs\Exceptions\ViewNotSetException::class);
